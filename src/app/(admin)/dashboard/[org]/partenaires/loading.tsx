export default function PartenairesLoading() {
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="mc-cards-grid">{Array.from({ length: 4 }).map((_, i) => (<div key={i} className="mc-card p-5"><div className="mc-skeleton h-10 w-2/3" /><div className="mc-skeleton mt-3 h-8 w-full" /></div>))}</div>
    </div>
  );
}
