...
/** Frontière d'erreur du module Réservations (jamais d'écran blanc). */
export default function ReservationsError({
  ...
  useEffect(() => {
    console.error("Réservations — erreur de rendu/chargement :", error);
  }, [error]);
  ...
  return (
    <div className="mc-card">
      <div className="mc-empty">
        ...
        <div className="mc-empty-title">Impossible de charger les réservations</div>
