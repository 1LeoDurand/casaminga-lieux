/** État de chargement (skeleton) du module Espaces. */
      ...
      <div className="mc-cards-grid">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="mc-card overflow-hidden">
            <div className="mc-skeleton aspect-[16/10] w-full" />
            <div className="p-4">
              <div className="mc-skeleton h-5 w-3/4" />
              <div className="mc-skeleton mt-3 h-3 w-1/2" />
              <div className="mc-skeleton mt-4 h-5 w-24" />
            </div>
          </div>
        ))}
      </div>
