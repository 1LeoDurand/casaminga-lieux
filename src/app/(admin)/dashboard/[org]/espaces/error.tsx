...
/** Frontière d'erreur du module Espaces (jamais d'écran blanc). */
export default function EspacesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Espaces — erreur de rendu/chargement :", error);
  }, [error]);
  ...
  return (
    <div className="mc-card">
      <div className="mc-empty">
        ...
        <div className="mc-empty-title">Impossible de charger les espaces</div>
