...
/** Frontière d'erreur du module Personnes (jamais d'écran blanc). */
export default function PersonnesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Personnes — erreur de rendu/chargement :", error);
  }, [error]);
  ...
  return (
    <div className="mc-card">
      <div className="mc-empty">
        ...
        <div className="mc-empty-title">Impossible de charger les personnes</div>
