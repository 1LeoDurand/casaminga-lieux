...
export const MODULE_SECTIONS: ModuleSection[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { key: "inventaire", label: "Inventaire", segment: "inventaire", layer: 2, tableKey: "assets",     description: "Matériel, prêts, maintenance — qui a quoi.", minTier: "complete" },
    ],
  },
  {
    key: "finances",
...
export const ORG_ARCHETYPES: OrgArchetype[] = [
  {
    ...
    modules: ["espaces", "evenements", "adhesions", "taches", "inventaire", "contrats"],
  },
  {
    key: "coworking",
    emoji: "💻",
    ...
    modules: ["espaces", "factures", "finances", "taches", "contrats"],
  },
  {
    key: "culturel",
    emoji: "🎭",
  ...
  },
  {
    ...
    modules: ["adhesions", "finances", "communication", "taches", "dons"],
  },
  {
    key: "autre",
    emoji: "➕",
